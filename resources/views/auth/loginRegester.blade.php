...
<html lang="en" >
    ...
    {!! NoCaptcha::renderJs() !!}
    @include('auth.includes.headerLogReg1')
<body>
<!-- partial:index.partial.html -->
<!DOCTYPE html>
<html lang="es" dir="ltr">
    @include('auth.includes.headerLogReg2')
<body>
    <div class="main">
        <div class="container a-container" id="a-container">
            <form class="form" id="a-form" method="POST" action="{{ route('register') }}">
                ...
                <input class="form__input @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Name" required autofocus>
                @error('name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
                <input class="form__input @error('email') is-invalid @enderror" id="email" name="email" type="email" placeholder="Email" value="{{ old('email') }}" required autocomplete="email">
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
                <input class="form__input @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" id="password" type="password" placeholder="Password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <input id="password-confirm" type="password" class="form__input" name="password_confirmation" required autocomplete="new-password"  placeholder="Confirm Password">
                ...
                <button type="submit" class="switch__button button">SIGN UP</button>
            </form>
        </div>
        <div class="container b-container" id="b-container">
            ...
            @csrf
                ...
                <input class="form__input @error('email') is-invalid @enderror" name="email" id="email" type="text" name="email" placeholder="Email" required autofocus>
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                <input class="form__input @error('password') is-invalid @enderror" name="password" id="password" type="password" placeholder="Password" required>
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                @if (Route::has('password.request'))
                    <a class="form__link btn btn-link" href="{{ route('password.request') }}">
                ...
                <button type="submit" class="switch__button button">SIGN IN</button>
            </form>
        ...
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container" id="switch-c1">
                ...
                <a href="{{ route('welcome') }}">
                    <button type="button" class="switch__button button" style="margin: 17px; height: 25px; width: 66px; padding: 0">HOME</button>
                </a>
            </div>
    ...
    @include('auth.includes.footerLogReg')
</body>
</html>
