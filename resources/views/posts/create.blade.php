...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="jumbotron" style="background-color: #EAEEF2; padding: 1.7%; padding-bottom: 3%; border-radius: 20px 20px">
                ...
                <a class="btn btn-primary btn-lg" href="{{route('posts')}}" style="padding: 0" role="button">Posts</a>
            </div>
        </div>
    </div>
    <hr class="my-4">
    ...
    <div class="row">
        ...
        @endif
        <div class="col">
            <form action=" {{route('post.store')}} " method="POST" enctype="multipart/form-data"> {{-- enctype="multipart/form-data" => To allow the photo to be uploaded --}}
                @csrf
